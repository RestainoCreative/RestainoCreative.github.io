...
const FALLBACK_ABOUT = {
  ...
  highlights: [
    "3× Emmy Award winner",
    "NFL on CBS · March Madness · UFC",
    "Dragons & virtual artists live for 30–40k",
    "Real-time visuals at the Sphere",
  ],
  ...
  return (
    <nav className="nav">
      <div className="nav-links">
        <a href="index.html" className="nav-link" data-hover><span className="lbl"><span className="lbl-inner" data-text="Home">Home</span></span></a>
        ...
        <span className="nav-link is-current" data-hover><span className="lbl"><span className="lbl-inner" data-text="About Me">About Me</span></span></span>
      </div>
      <div className="nav-links">
  ...
  return (
    <section className="ab-bio">
      <div className="ab-bio-inner">
        ...
        {highlights.length > 0 && (
          <div className="ab-highlights reveal reveal-d-1">
            {highlights.map((h, i) => <span className="ab-highlight" key={i}>{h}</span>)}
          </div>
        )}
      </div>
    </section>
